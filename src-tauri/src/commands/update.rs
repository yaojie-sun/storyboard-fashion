...
const VERSION_CHECK_URL: &str = "https://aixiaoxi.top/jy/uploads/app/version_fashion.json";
const GRID_PROMPT_RULES_URL: &str = "https://aixiaoxi.top/jy/uploads/app/grid_prompt_rules_fashion.json";
...
fn resolve_video_gen_rules_url(model: Option<String>) -> String {
    ...
    let file = match model.as_str() {
        "happyhorse_r2v" | "happyhorse/happyhorse-1.0-r2v" | "happyhorse/happyhorse-1.1-r2v" => "video_gen_rules_fashion.json",
        "fashion_r2v" | "travel/fashion-1.0-r2v" => "video_gen_rules_fashion.json",
...
fn installer_name(version: &str) -> String {
    ...
    {
        format!("Storyboard-Fashion_{}_x64-setup.exe", version)
    }
    #[cfg(target_os = "macos")]
    {
        format!("Storyboard-Fashion_{}_universal.dmg", version)
    }
